...
#  Usage:  curl -fsSL https://raw.githubusercontent.com/alimtvnetwork/scripts-fixer-v18/main/install.sh | bash
#
...
FALLBACK_SLUG="scripts-fixer-v18"
...
# Args: <repo-vN-name>   (e.g. scripts-fixer-v18)
