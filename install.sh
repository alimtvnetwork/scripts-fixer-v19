...
#  Usage:  curl -fsSL https://raw.githubusercontent.com/alimtvnetwork/scripts-fixer-v17/main/install.sh | bash
#
...
FALLBACK_SLUG="scripts-fixer-v17"
...
# Args: <repo-vN-name>   (e.g. scripts-fixer-v17)
