#!/usr/bin/env bash
# 35-install-gitmap -- gitmap CLI (curl one-liner from gitmap-v23 main branch)
set -u
...
# points at a path inside the gitmap-v23 repo (default: main branch).
# ---------------------------------------------------------------------------
TAG_FLAG=""
ARGS=()
while [ "$#" -gt 0 ]; do
...
URL_TEMPLATE="${CONFIG_URL_TEMPLATE:-https://raw.githubusercontent.com/alimtvnetwork/gitmap-v23/{tag}/install.sh}"
